...
//            dialog.getWindow().setStatusBarColor(R.color.appcolor);
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<>(MemberListActivity.this, android.R.layout.simple_list_item_1, stringStateArrayList);
...
//        rv_memberList.setLayoutManager(new LinearLayoutManager(MemberListActivity.this, LinearLayoutManager.VERTICAL, false));

        LinearLayoutManager mLayoutManager = new LinearLayoutManager(MemberListActivity.this, LinearLayoutManager.VERTICAL, false);
        rv_memberList.setLayoutManager(mLayoutManager);

//        nestedScrollView.setOnScrollStoppedListener
            ...
            public void onScrollChange(View view, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (nestedScrollView.getChildAt(nestedScrollView.getChildCount() - 1) != null) {
                    if ((scrollY >= (nestedScrollView.getChildAt(nestedScrollView.getChildCount() - 1).getMeasuredHeight() - nestedScrollView.getMeasuredHeight())) && scrollY > oldScrollY) {
                        if (tv_state.getText().toString().matches("Select State")){
        ...
        memberAdapter = new MemberAdapter(MemberListActivity.this, memberArrayList, new OnItemClickListener() {
            @Override
        ...
        rv_memberList.setAdapter(memberAdapter);
...
//                filter(newText);
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) MemberListActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            Toast.makeText(MemberListActivity.this, "No Internet Connection", Toast.LENGTH_LONG).show();
        }
                        ...
                        if (stateList != null && !stateList.isEmpty() && stateList.size() > 0) {
                            for (int i = 0; i < stateList.size(); i++) {
                               ...
                               /* image_buysilk.setOnClickListener(view1 -> {
                                    AlertDialog.Builder mBuilder = new AlertDialog.Builder(MemberListActivity.this);
                            ...
                            Toast.makeText(MemberListActivity.this, "Buy Silk Not Available", Toast.LENGTH_SHORT).show();
                        }
...
//            dialog.getWindow().setLayout(800, 1000);
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter(MemberListActivity.this, android.R.layout.simple_list_item_1, stringCityArrayList);
            listView.setAdapter(adapter);
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().matches("200")) {
                        ...
                        if (stateList != null && !stateList.isEmpty() && stateList.size() > 0) {
                            ...
                            Toast.makeText(MemberListActivity.this, "City Not Available", Toast.LENGTH_SHORT).show();
                        }
...
//                                Log.d("state>>", name);
                            ...
                            Toast.makeText(MemberListActivity.this, "State Not Available", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
    ...
    private void getMembers() {
        ...
        final ProgressDialog pDialog = new ProgressDialog(MemberListActivity.this, R.style.MyAlertDialogStyle);
        pDialog.setMessage("Please wait...");
        pDialog.setCancelable(false);
        pDialog.show();

        SharedPreferences sharedpreferences = MemberListActivity.this.getSharedPreferences(AppConstant.LOGGED_IN_PREF, Context.MODE_PRIVATE);
            ...
            public void onResponse(Call<MemberResponse> call, Response<MemberResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().matches("400")) {
                        ...
                        Toast.makeText(MemberListActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
...
//                                String id = memberList.get(i).getId();
                            ...
                            memberAdapter.updateList(memberArrayList);
                            ...
                            Toast.makeText(MemberListActivity.this, "MemberList Not Available", Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onFailure(Call<MemberResponse> call, Throwable t) {
                ...
                Toast.makeText(MemberListActivity.this, "Something went wrong please try again", Toast.LENGTH_LONG).show();
            }
        });
...
//            rv_memberList.setVisibility(View.GONE);
            Toast.makeText(MemberListActivity.this, "No Match Found", Toast.LENGTH_SHORT).show();
        } else {
...
//        ((MainActivity) MemberListActivity.this).getFragmentTag(4);
    }
