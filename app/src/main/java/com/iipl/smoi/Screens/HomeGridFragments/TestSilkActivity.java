...
import com.iipl.smoi.Adapter.TestSilkAdapter;
...
import com.iipl.smoi.GMap.TestSilkMapsActivity;
...
import com.iipl.smoi.Screens.ActivityActions.ChapterDetails;
...
public class TestSilkActivity extends AppCompatActivity implements TestSilkAdapter.OnItemGMapClickListener {
...
//    ChapterAdapter chapterAdapter;
    ...
    TestSilkAdapter testSilkAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_silk);
        ...
        rv_chapterList.setLayoutManager(new LinearLayoutManager(TestSilkActivity.this, LinearLayoutManager.VERTICAL, false));


        tv_title_chapter.setText(R.string.testsilk);
      ...
      /*  Bundle intent = getIntent().getExtras();
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TestSilkActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });


        ConnectivityManager connectivityManager = (ConnectivityManager) TestSilkActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            Toast.makeText(TestSilkActivity.this, "No Internet Connection", Toast.LENGTH_LONG).show();
        }
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().matches("200")) {
                        ...
                        if (stateList != null && !stateList.isEmpty() && stateList.size() > 0) {
                            ...
                            Toast.makeText(TestSilkActivity.this, "Test Silk Not Available", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void getChapter() {
        final ProgressDialog pDialog = new ProgressDialog(TestSilkActivity.this, R.style.MyAlertDialogStyle);
        pDialog.setMessage("Please wait...");
        pDialog.setCancelable(false);
        pDialog.show();

        SharedPreferences sharedpreferences = TestSilkActivity.this.getSharedPreferences(AppConstant.LOGGED_IN_PREF, Context.MODE_PRIVATE);
        ...
        call.enqueue(new Callback<ChapterResponse>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().matches("200")) {
                        ...
                        if (chapterList != null && !chapterList.isEmpty() && chapterList.size() > 0) {
                            ...
                            testSilkAdapter = new TestSilkAdapter(TestSilkActivity.this, chapterArrayList, (OnItemClickListener) position -> {
                                ...
                                Intent intent = new Intent(TestSilkActivity.this, ChapterDetails.class);
                            ...
                            getcallback();
                            rv_chapterList.setAdapter(testSilkAdapter);
                        } else {

                            Toast.makeText(TestSilkActivity.this, "chapterList Not Available", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ChapterResponse> call, Throwable t) {
                ...
                Toast.makeText(TestSilkActivity.this, "Something went wrong please try again", Toast.LENGTH_LONG).show();
            }
        });
    }

    private void getcallback() {
        testSilkAdapter.setOnItemGMap(this);
    }
    ...
    private void filter(String text) {
        ...
        if (filteredlist.isEmpty()) {
            ...
            Toast.makeText(TestSilkActivity.this, "No Match Found", Toast.LENGTH_SHORT).show();
        } else {
            testSilkAdapter.filterList(filteredlist);
        }
    }
    ...
    public void onItemGMapClick(int position) {
        ...
        if (latitude != null && longitude != null) {
            if (!latitude.isEmpty()) {
                ...
                Intent intent = new Intent(TestSilkActivity.this, TestSilkMapsActivity.class);
                startActivity(intent);
                finish();
