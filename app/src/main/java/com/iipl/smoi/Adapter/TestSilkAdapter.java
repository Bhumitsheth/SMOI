...
public class TestSilkAdapter extends RecyclerView.Adapter<TestSilkAdapter.myDataViewHolder> {
    ...
    public TestSilkAdapter(Context context, ArrayList<ChapterResponse.Chapter> chapterArrayList,
    ...
    @NonNull
    @Override
    public TestSilkAdapter.myDataViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
