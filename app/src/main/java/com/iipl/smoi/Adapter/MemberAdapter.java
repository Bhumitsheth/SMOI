...
public class MemberAdapter extends RecyclerView.Adapter<MemberAdapter.mydataviewholder> {
    ...
    public MemberAdapter(Context context, ArrayList<MemberResponse.Member> memberArrayList, OnItemClickListener onItemClickListener) {
   ...
   /* public void filterList(ArrayList<MemberResponse.Member> filterllist) {
    ...
    @Override
    public MemberAdapter.mydataviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.img_google_map.setOnClickListener(view -> {
            ...
            if ((latitude != null) && longitude != null) {
                if (!latitude.isEmpty()){
                    ...
                    Intent intent = new Intent(context, MemberMapsActivity.class);
